...
def navigation_guidance(detected_objects):
    # Check for obstacles in the path (e.g., people, cars, or any close object)
    if "person" in detected_objects:
        speak("Person detected in front.")
    if "car" in detected_objects:
        speak("Car detected ahead.")
    if "bottle" in detected_objects:
        speak("Small object detected in front.")
    # Add more object checks here depending on the situation
